...
const fixtureMap: Record<string, { type: 'success' | 'error'; schema?: string; expectedCode?: string }> = {
  ...
  'invites/pending.json': { type: 'success', schema: 'pendingInvitePreviewSchema' },
  'invites/consumed-matching-session.json': { type: 'success', schema: 'acceptedInviteResponseSchema' },
